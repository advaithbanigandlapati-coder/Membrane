...
// Registration and authentication both round-trip through Edge Functions
// that do the actual server-side verification (challenge issuance + sig
// verification) — this file is the browser side only. Client-only WebAuthn
// verification would be theater; the server check is what makes this real.
